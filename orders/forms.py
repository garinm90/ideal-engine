...
from orders.models import Controller, ControllerImage
...
class ControllerForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.helper.form_id = 'id-controller-form'
...
class ControllerImageForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        super(ControllerImageForm, self).__init__(*args, **kwargs)
        self.helper = FormHelper()
        self.helper.form_id = 'id-imageForm'
        self.helper.form_class = 'imageForm'
        self.helper.form_method = 'post'
